...
class Accounts_form {
	...
	function get_customer_form_fields($entity_type = false, $id = false) {
		...
		array('', 'HIDDEN', array('name' => 'type', 'value' => $type), '', '', ''),
			...
			array(gettext('Invoice Template'), array('name' => 'invoice_template_id', 'class' => 'invoice_template_id'), 'SELECT', '', array("name" => "invoice_template_id", "rules" => "required"), 'tOOL TIP', 'Please Enter account number', 'id', 'name', 'invoice_templates', 'build_dropdown', 'where_arr', array('type' => 'I')),
			array(gettext('Receipt Template'), array('name' => 'receipt_template_id', 'class' => 'receipt_template_id'), 'SELECT', '', array("name" => "receipt_template_id", "rules" => "required"), 'tOOL TIP', 'Please Enter account number', 'id', 'name', 'invoice_templates', 'build_dropdown', 'where_arr', array('type' => 'R')),
			array(gettext('General field 1'), 'INPUT', array('name' => 'general_field1', 'id' => 'general_field1', 'size' => '15', 'class' => "text field medium"), '', 'tOOL TIP', ''),
			array(gettext('General field 2'), 'INPUT', array('name' => 'general_field2', 'id' => 'general_field2', 'size' => '15', 'class' => "text field medium"), '', 'tOOL TIP', ''),
			array(gettext('General field 3'), 'INPUT', array('name' => 'general_field3', 'id' => 'general_field3', 'size' => '15', 'class' => "text field medium"), '', 'tOOL TIP', ''),
			array(gettext('General field 4'), 'INPUT', array('name' => 'general_field4', 'id' => 'general_field4', 'size' => '15', 'class' => "text field medium"), '', 'tOOL TIP', ''),
			array(gettext('General field 5'), 'INPUT', array('name' => 'general_field5', 'id' => 'general_field5', 'size' => '15', 'class' => "text field medium"), '', 'tOOL TIP', '')
		);
